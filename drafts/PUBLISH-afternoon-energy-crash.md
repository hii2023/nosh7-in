# Publish instructions: 3 PM Energy Crash article

Publish the pre-written article that is staged at
`drafts/blog-afternoon-energy-crash-ahmedabad.html` onto the live NOSH7 site.
...
If `drafts/blog-afternoon-energy-crash-ahmedabad.html` does NOT exist, the article
was already published. Stop and report that, do nothing else.

## Step 2 — Move the article into the site root
Run: `git mv drafts/blog-afternoon-energy-crash-ahmedabad.html blog-afternoon-energy-crash-ahmedabad.html`
...
```html
    <a href="https://nosh7.in/blog-afternoon-energy-crash-ahmedabad.html" data-cat="lifestyle" class="blog-card">
      <div class="blog-card-top" style="color:#c2410c; background: linear-gradient(135deg, #ffedd5, #fdba74);"><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div>
      <div class="blog-card-body">
        <div class="blog-card-tag">Productivity</div>
        <div class="blog-card-title">Beat the 3 PM Energy Crash: Why Your Lunch Is the Real Culprit</div>
        <div class="blog-card-desc">The post-lunch slump that kills your afternoon focus is caused by what you eat, not how you slept. Why heavy meals crash your energy and the light, protein-rich lunch that keeps you sharp.</div>
...
```xml
  <url>
    <loc>https://nosh7.in/blog-afternoon-energy-crash-ahmedabad.html</loc>
...
Run: `git rm drafts/PUBLISH-afternoon-energy-crash.md`

## Step 7 — Commit and push
Stage everything (`git add -A`), commit with message
`blog: publish 'Beat the 3 PM Energy Crash'`, then run
